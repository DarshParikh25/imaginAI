            ...
            </Link>
            {
                ...
                <div className='flex items-center gap-3 sm:gap-5'>
                    <button onClick={() => navigate("/buy-credits")} className='bg-[#b49166] text-black rounded-full px-4 py-2 sm:py-2.5 sm:px-4 flex items-center gap-2 border-none hover:scale-105 transition-all duration-500 cursor-pointer'>
                        ...
                        <p className='text-xs sm:text-sm font-medium'>Credits left: {5}</p>
                    </button>
                    <div className='flex items-center gap-1.5 sm:gap-2.5'>
                        <p className='max-sm:hidden'>Hi, {'Darsh Parikh'}!</p>
                        <div className='relative group cursor-pointer'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 -right-1.5 z-10 rounded pt-12'>
                                <ul className='list-none m-0 p-2 bg-[#b49166] text-black text-sm rounded-lg'>
                                    <li className='px-1 py-1 cursor-pointer pr-10'>Logout</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex items-center gap-3 sm:gap-8'>
                    ...
                    <button onClick={() => navigate("/login")} className='bg-[#b49166] border-none text-black px-5 py-2.5 sm:px-8 rounded-full text-sm cursor-pointer hover:bg-[#a17f5c] transition-all duration-300'>Login</button>
                </div>
            }
        </div>
    )
